...
-(void)generateFailStyle{
    ...
    [trianglePath moveToPoint:CGPointMake((self.barLength-1)*self.currentProgress+10, 8)];
    [trianglePath addLineToPoint:CGPointMake((self.barLength-1)*self.currentProgress+5, 8)];
    [trianglePath addLineToPoint:CGPointMake((self.barLength-1)*self.currentProgress+7.5, 3)];
