...
//进度条bar
-(void)addProgressBar{
    self.progressBar = [[BLEProgressBar alloc]initWithFrame:CGRectMake(45, 10, 200, 60) delegate:self];
...
//进度条进度提示
-(void)addIndicator{
    self.progressIndicator = [[BLEProgressIndicator alloc]initWithFrame:CGRectMake(0, 20, 45, 80) delegate:self];
    [self.progressIndicator originate];
//    self.progressIndicator.center = CGPointMake(self.frame.size.width/2, self.frame.size.height/4);
