...
@implementation DotGPUImageBeautyFilter
...
- (void)setInputSize:(CGSize)newSize atIndex:(NSInteger)textureIndex {
    ...
    if(_isVertical){
        nnsize = CGSizeMake(newSize.width, newSize.height);
    }else{
        nnsize = CGSizeMake(newSize.height, newSize.width);
    }
    
    [super setInputSize:nnsize atIndex:textureIndex];
    inputTextureSize = nnsize;
