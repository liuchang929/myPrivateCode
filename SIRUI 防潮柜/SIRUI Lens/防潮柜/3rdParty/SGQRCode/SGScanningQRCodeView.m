...
#pragma mark - - - 扫描外部View的创建
    ...
    CGFloat promptLabelW = self.frame.size.width-40;
    CGFloat promptLabelH = 45;
    ...
    promptLabel.text = NSLocalizedString(@"QRCodePrompt", nil);
    ...
    [light_button setTitle:NSLocalizedString(@"Turn on the Flash Light", nil) forState:UIControlStateNormal];
    [light_button setTitle:NSLocalizedString(@"Turn off the Flash Light", nil) forState:UIControlStateSelected];
