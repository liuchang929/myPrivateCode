...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  =kColorLightBlue.CGColor;// [UIColor colorWithRed:0/255.0f green:50.0/255.0f blue:50.0/255.0f alpha:1].CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB(20, 203, 0) CGColor],(id)[RGB(20, 203, 0) CGColor],(id)[RGB(255, 200, 0) CGColor],(id)[RGB(255, 200, 0) CGColor],(id)[RGB(255, 200, 0) CGColor],(id)[RGB(255, 200, 0) CGColor],nil]];
    ...
    _endPoint.image = [UIImage imageNamed:@"check"];
