...
- (void)viewDidLoad {
    ...
    NSURL *URL = [NSURL URLWithString:@"http://cn.sirui.com/api/app/instructions/product/hs70x"];
    if([_url containsString:@"en"])
    {
        URL = [NSURL URLWithString:@"http://en.sirui.com/api/app/instructions/product/hs70x"];
    }
